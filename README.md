...
Navigate to your deployed URL (e.g., Vercel or GitHub Pages).
...
Library: Upload your light frames (tracked exposures of 30s-120s work best).

Reference: Select your sharpest frame as the "Master" using the crosshair icon.

Integrate: Hit the "Run Integration" button.

Develop: Use the "Nebula Stretch" slider to bring out faint details and "Black Level" to darken the sky background.

Export: Save your master PNG for final touch-ups in Photoshop or Lightroom.
